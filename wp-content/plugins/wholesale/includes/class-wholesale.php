...
class Wholesale {
	...
	public function __construct() {
		if ( defined( 'WHOLESALE_VERSION' ) ) {
			$this->version = WHOLESALE_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'wholesale';
	 ...
	 *
	 * - Wholesale_Loader. Orchestrates the hooks of the plugin.
	 * - Wholesale_i18n. Defines internationalization functionality.
	 * - Wholesale_Admin. Defines all hooks for the admin area.
	 * - Wholesale_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-wholesale-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-wholesale-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-wholesale-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-wholesale-public.php';

		$this->loader = new Wholesale_Loader();
	 ...
	 *
	 * Uses the Wholesale_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * access   private
	...
	private function set_locale() {
		...
		$plugin_i18n = new Wholesale_i18n();
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Wholesale_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Wholesale_Public( $this->get_plugin_name(), $this->get_version() );
	 ...
	 *
	 * @since     1.0.0
	 * @return    Wholesale_Loader    Orchestrates the hooks of the plugin.
	 */
